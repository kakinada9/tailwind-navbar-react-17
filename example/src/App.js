...
const App = () => {
  ...
  return (
    <>
        ...
        <nav>
          <ul className="items-center justify-between pt-4 text-base lg:flex lg:pt-0">
            {links.map(link => {
              ...
              return (
                <li>
                  <a className="block px-0 py-3 border-b-2 border-transparent lg:p-4 hover:border-indigo-400 transition-all duration-200" href={link.link}>
                    {link.name}
                  </a>
                </li>
              );
      ...
      <div className="flex p-5 flex-col justify-center text-center" style={{minWidth: "100vw", minHeight: "100vh"}}>
        <h1 className="text-5xl font-semibold">This is a responsive navbar!</h1>
        <p className="text-2xl">Try resizing the window to see how it responds to different screen sizes.</p>
        <a href="https://www.npmjs.com/package/tailwind-navbar-react" className="text-xl underline text-teal-600">
          Take a look at our React component!
        </a>
      </div>
    </>
  );
